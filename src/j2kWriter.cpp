...
j2kWriter::j2kWriter(DD::Image::Write *iop)
...
void j2kWriter::knobs(DD::Image::Knob_Callback f)
{
...
const DD::Image::Writer::Description j2kWriter::Desc("j2k\0", build);
